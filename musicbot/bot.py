...
#######################################################################################################################
    ...
    def _gen_embed(self):
        ...
        e = discord.Embed()
        e.colour = 7506394
        e.set_footer(text='redhotdj', icon_url='https://i.imgur.com/iTyQkn9.png')
        e.set_author(name=self.user.name, url='https://redhotsonic.com', icon_url=self.user.avatar_url)
        return e
